...
\end{subfigure}
\caption{Basis-Textur (\subref{fig:pmrem-basis}) und die ersten vier \ac{PMREM} Stufen einer Fläche der Environment Cubemap (\subref{fig:pmrem-1} - \subref{fig:pmrem-4})}
\end{figure}
